	...
	export default{
		...
		methods:{
			getnav:function(name){
				var self=this
				return Promise.all([
					this.axios.post('http://127.0.0.1/selfweba/index.php/Home/Index/index'),
					this.axios.get('http://127.0.0.1/selfweba/index.php/Home/Index/getsecondnav?onenav='+name)
